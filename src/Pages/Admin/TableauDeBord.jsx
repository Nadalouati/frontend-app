  ...
  return (
    <div className="container" style={{height : "auto",marginTop:"3em"}}>
      <div className="box box-left"> 
        ...
        <h2 className="title1" style={{fontSize : "1.5em"}}>Cliquer ici pour créer un compte livreur</h2>
      ...
      <div className="box box-right"> 
        ...
        <h2 className="title2" style={{fontSize : "1.5em"}}>Cliquer ici pour créer un compte Entreprise</h2>
